<template>
  <div class="fixed right-4 bottom-4 z-50">
    <!-- 主按钮 - 使用Popover组件 -->
    <el-popover placement="top-start" :width="200" trigger="hover" popper-class="contact-popover">
      <template #reference>
        <el-button type="primary" class="main-call-btn" round>
          <div class="flex flex-col items-center justify-center">
            <el-icon class="text-xl">
              <Service />
            </el-icon>
            <span class="text-sm mt-1">联系我们</span>
          </div>
        </el-button>
      </template>
...
import { Box, Setting, Medal, MoreFilled, Service, Close } from '@element-plus/icons-vue';
...
const handleMaterialCall = () => {
  services.sendMesWebSocket({
    userIds: [1, '1831986097686552578'],
    message: JSON.stringify({
      'title': '物料呼叫',
      'content': 'SA0082生产线需要物料补给',
      'category': 'alert',
      'priority': 3,
      'line': 'SA0082',
      'material': 'XYZ-123'
...
.contact-popover .el-popper__arrow {
