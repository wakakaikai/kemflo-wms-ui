  ...
  <div class="p-2">
        ...
        <el-card shadow="hover">
          <el-form ref="queryFormRef" :model="queryParams" :inline="true" label-width="auto">
            ...
            <el-form-item label="资产号" prop="assetNo">
              <el-input v-model="queryParams.assetNo" placeholder="请输入资产号" clearable @keyup.enter="handleQuery" />
            </el-form-item>
            <el-form-item label="资产子编号" prop="assetNoItem">
              <el-input v-model="queryParams.assetNoItem" placeholder="请输入资产子编号" clearable @keyup.enter="handleQuery" />
            </el-form-item>
    ...
    <el-card shadow="never">
      ...
      <el-table v-loading="loading" :data="inventoryMovementList" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="资产号" align="center" prop="assetNo" />
        <el-table-column label="资产子编号" align="center" prop="assetNoItem" />
    ...
    <el-dialog :title="dialog.title" v-model="dialog.visible" width="500px" append-to-body>
      <el-form ref="inventoryMovementFormRef" :model="form" :rules="rules" label-width="auto">
        ...
        <el-form-item label="资产子编号" prop="assetNoItem">
          <el-input v-model="form.assetNoItem" placeholder="请输入资产子编号" />
        </el-form-item>
        <el-form-item label="移动时间" prop="moveDate">
        ...
        <el-form-item label="接收日期" prop="receiptDate">
          <el-date-picker clearable v-model="form.receiptDate" type="datetime" value-format="YYYY-MM-DD HH:mm:ss" placeholder="请选择接收日期"> </el-date-picker>
        </el-form-item>
        <el-form-item label="失效日期" prop="expireDate">
...
const data = reactive<PageData<InventoryMovementForm, InventoryMovementQuery>>({
  ...
  rules: {
    ...
    // vendorCode: [{ required: true, message: '供应商编号不能为空', trigger: 'blur' }],
    ...
    // assetNo: [{ required: true, message: '资产号不能为空', trigger: 'blur' }],
    // assetNoItem: [{ required: true, message: '资产子编号不能为空', trigger: 'blur' }],
    // moveDate: [{ required: true, message: '移动时间不能为空', trigger: 'blur' }],
    // receiptDate: [{ required: true, message: '接收日期不能为空', trigger: 'blur' }],
