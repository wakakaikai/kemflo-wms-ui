      ...
      <el-card v-if="palletStatusNormal" class="scan-area">
        <template #header>
          <div class="card-header">
            ...
            <el-button v-if="formData.id" v-hasPermi="['wms:packingData:edit']" type="success" plain icon="Edit" :disabled="!canGenerateEntries" @click="generateStorageDialog()">修改入库单</el-button>
            <el-button v-else v-hasPermi="['wms:packingData:add']" type="primary" plain icon="Plus" :disabled="!canGenerateEntries" @click="generateStorageDialog">生成入库单</el-button>
          </div>
        </template>
