      ...
      <el-form ref="workOrderSnFormRef" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="公司名称" prop="companyName">
          <el-select v-model="form.companyName" placeholder="请选择公司名称">
            <el-option v-for="dict in wms_company_name" :key="dict.value" :label="dict.label" :value="dict.value"></el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="工单号" prop="workOrderNo">
        ...
        <el-form-item label="顺序" prop="sequence">
          <el-input v-model="form.sequence" placeholder="请输入顺序" />
        </el-form-item>
        <el-form-item label="生产线别" prop="productLine">
          <el-input v-model="form.productLine" placeholder="请输入生产线别" />
        </el-form-item>
        <el-form-item label="生产日期" prop="productDate">
          <el-date-picker clearable v-model="form.productDate" type="date" value-format="YYYY-MM-DD HH:mm:ss" :disabled-date="disabledFutureDate" placeholder="请选择生产日期"> </el-date-picker>
        </el-form-item>
...
const data = reactive<PageData<WorkOrderSnForm, WorkOrderSnQuery>>({
  ...
  rules: {
    ...
    sn: [{ required: true, message: '条码不能为空', trigger: 'blur' }],
    qty: [{ required: true, message: '数量不能为空', trigger: 'blur' }],
    productLine: [{ required: true, message: '生产线别不能为空', trigger: 'blur' }],
