      ...
      <template #header>
        <div class="workbench-header">
          <div>
            ...
            <p class="subtitle">{{ WORKBENCH_SUBTITLE }}</p>
          </div>
        </div>
      </template>
      <workbench-panel />
...
import { WORKBENCH_SUBTITLE } from '@/api/wms/allocation/types';
</script>
<style scoped>
.workbench-header { display: flex; justify-content: space-between; align-items: flex-start; }
