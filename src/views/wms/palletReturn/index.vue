      ...
      <div v-show="historyExpanded" class="history-card-body">
        <el-form v-show="showSearch" ref="queryFormRef" :model="queryParams" label-width="auto" class="packing-return-search-form">
          <el-row :gutter="16">
            ...
            <el-col :xs="24" :sm="12" :md="8" :lg="4" :xl="2">
        ...
        <div class="search-result">
          <el-table ref="packingTableRef" v-loading="loading" :data="packingDetailList" height="300" border @selection-change="handleSelectionChange">
    ...
    <el-card shadow="never" class="transfer-main-card" :class="{ 'is-transfer-collapsed': !transferExpanded }">
      ...
      <div v-show="transferExpanded" class="transfer-card-body">
        ...
        <div class="submit-bar">
          <el-button v-hasPermi="['wms:packingDetail:return']" type="primary" :loading="buttonLoading" :disabled="returnList.length === 0" @click="submitReturn"> 提交退货 </el-button>
        </div>
      </div>
    </el-card>
  </div>
