      ...
      <template #header>
        <div class="card-header">
          <div class="card-header-left" @click="pageExpanded = !pageExpanded">
            ...
            <span class="card-title">库存冲销</span>
          </div>
...
function syncDocYearFromList() {
  const firstRow = inventoryDetailList.value[0];
  if (firstRow?.sapMaterialDocYear != null) {
    cancelForm.value.sapMaterialDocYear = firstRow.sapMaterialDocYear;
  }
}
...
const handleQuery = async () => {
  ...
  queryParams.value.sapMaterialOrderNo = voucherNo;
