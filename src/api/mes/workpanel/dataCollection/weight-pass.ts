/**
 * 称重站数据收集过站入参组装（对齐 /mes/dataCollection/passSfc → DataCollectionBo）
 */
...
/**
 * 转成后端 DcParameterBo（字段与 org.dromara.wms.domain.mes.bo.DcParameterBo 对齐）
